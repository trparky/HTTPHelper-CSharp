...
{
    private const string classVersion = "1.338";
    ...
    private readonly Dictionary<string, string> additionalHTTPHeaders = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
    private readonly Dictionary<string, CookieDetails> httpCookies = new Dictionary<string, CookieDetails>(StringComparer.OrdinalIgnoreCase);
    private readonly Dictionary<string, object> postData = new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase);
    private readonly Dictionary<string, string> getData = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
